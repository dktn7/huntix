...
## 12. Color System
Base world colors should be dark navy, black, charcoal, steel, and muted gray. Hunter accent colors should be bold and individual: Dabik purple-black, Benzu red-gold, Sereisa yellow-white, Vesol blue-crimson. UI accents can echo each hunter color without overwhelming readability.

## 13. HUD
The HUD should show health, mana, surge, stamina, team status, currency, and boss health when relevant. It should stay compact and modern, with clear color coding and minimal clutter. Co-op players need easy-to-read indicators at all times.

## 14. Resource System
Each hunter uses health, mana, surge, and stamina. Health defines survival, mana powers special abilities, surge unlocks ultimates, and stamina prevents sprint/dodge spam. The system should be simple enough to learn quickly but deep enough to reward timing and aggressive play.

## 15. Stamina
Stamina is a tactical limiter, not a punishment. Dodges and sprinting drain stamina, while passive regen and successful hits restore momentum. When stamina is low, the UI should warn the player visually without making the game feel sluggish.
...
## 17. Status Synergies
The elemental pairings are a major identity feature. Bleed and slow should work together for setup and punishment, stun and wall should trap enemies, slow and blink should create opening windows, and burn plus slam should create brutal area control. These synergies make the hunters feel like a coordinated elite squad.

## 18. Enemy Roster
- Grunt: basic melee pressure.
- Ranged unit: distance control and projectile pressure.
- Bruiser: slow, durable, dangerous.
- Mini-boss: zone gatekeeper with readable phases.
- Boss: multi-phase climax fight with strong telegraphs.

## 19. Zone Structure
### Hunter Hub
The hub is a safe urban base with portal access, shop, hunter select, and visual identity. It should feel like a modern secret district for elite hunters.

### City Breach
An urban ruin zone with broken streets, breached buildings, concrete, neon, and street-level combat.

### Ruin Den
A tighter underground or utility-zone environment with heavier danger, stronger pressure, and more enclosed encounters.

### Shadow Core
A final zone with the most dramatic magical corruption, strongest boss energy, and the clearest sense of escalation.

## 20. Progression
The game should use short runs, upgrades, and repeatable zones. Players earn currency from enemies and bosses, then spend it in the hub or between runs. Progression should always make the player feel more elite, more dangerous, and more visually dramatic.

## 21. Shop and Cosmetics
The shop should sell survival, power, mobility, utility, and cosmetic upgrades. Cosmetic options should include aura intensity, armor tint, weapon skin, and minor visual variants. Cosmetic changes should keep the character identity intact rather than replacing it.

## 22. Audio Direction
Audio should feel punchy, modern, and magical. Hunter movement, weapon impacts, aura bursts, and boss attacks need distinct sound layers. The world should sound like a premium action anime game, not a generic fantasy hack-and-slash.

## 23. Technical Direction
Build in Three.js with a lightweight, optimized asset pipeline. Keep models low-poly and readable, use instancing where possible, and prioritize fast startup over visual excess. The game should be playable immediately, with minimal assets loaded before the player can begin.
